...
module.exports = sendgridStatus = (email, name)=>{
  msg.to = email;
...
<p style="font-size: 12px; line-height: 16px; text-align: center; margin: 0;"><span style="font-size: 14px;"><strong>Login now at: localhost:3000</strong></span></p>
...
module.exports = sendgridWelcome = (email, password)=> {
